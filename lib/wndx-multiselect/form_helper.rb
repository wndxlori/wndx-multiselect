  ...
  module Helpers
    ...
    private
      ...
      def generate_multiselect(name, match, values, source, options={})
        ...
        button_tags = []
        button_tags << link_to_function( 'Add', "", :name => 'match2selected', :class => 'add')
        button_tags << link_to_function( 'Add All', {}, :name => 'match2selected', :class => 'all')
        button_tags << link_to_function( 'Remove', {}, :name => 'selected2match', :class => 'remove')
        button_tags << link_to_function( 'Remove All', {}, :name => 'selected2match', :class => 'all')
